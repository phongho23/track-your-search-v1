...
describe(`AddJob component`, () => {
  const sampleJobs = [
    {
      ...
      "weekId": 1,
      "jobtitle": "Software Engineer - Target",
      "companyname": "Target",
    ...
    },
    {
        ...
        "weekId": 2,
        "jobtitle": "Software Engineer - Wal-mart",
    ...
    },
    {
        ...
        "weekId": 3,
        "jobtitle": "Software Engineer - Lockheed",
  ...
  it.skip('renders the select options from jobs', () => {
    const context = { jobs: sampleJobs }
    const select = shallow(<AddJob />, context)
      .find('#job-week-select')
